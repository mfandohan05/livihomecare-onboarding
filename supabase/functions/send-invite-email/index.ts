...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Livi Home Care <noreply@livihomecare.com>',
        to: caregiver.email,
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <p style="color: #555; margin-bottom: 8px;">Your onboarding includes:</p>
            <ul style="color: #555; margin-bottom: 32px; padding-left: 20px;">
              <li>Uploading your required documents</li>
              <li>Completing your new hire orientation</li>
              <li>Filling out your tax forms (I-9, W-4, NC-4EZ)</li>
              <li>Signing your offer letter</li>
            </ul>
