...
export default function ERSPGuidePage({ stepLabel, onNext, initialData, onChange, companyData }) {
    const sections = [
        {
            id: 'app',
            icon: Smartphone,
            ...
            steps: [
                ...
                },
                {
                    ...
                    items: [
                        `Enter the URL: ${companyData.ersp_url}, then click "Next".`,
                        'Before entering your username and password, ensure the toggle is set to "Caregiver".',
                        `Enter the username and password provided by ${companyData.company_name} when your account was created.`,
                    ...
                    items: [
                        <>
                            ...
                            <a href="https://support.apple.com/guide/iphone/share-your-location-iph69b192bc2/ios"
                                target="_blank"
                                rel="noreferrer"
                                className="text-[var(--primary-color)] underline hover:text-[var(--hover-color)]"
                            >
                                Apple Support.
                            </a>
                        </>,
    ...
    return (
        <div className="max-w-2xl mx-auto py-8 md:py-16 px-4 md:px-8">
            ...
            <div className="flex items-center gap-2 mb-2">
                <MonitorPlay className="w-5 h-5 text-[var(--primary-color)]" />
            ...
            <p className="text-muted-foreground mb-8">
                ...
                schedule, complete activities, and communicate with the {companyData.company_name} team.
